...
{
    GFConditionFilterView *conditionFilter = [[GFConditionFilterView alloc] initWithFrame:CGRectMake(0, 0, SCREEN_WIDTH, 40)];
...
- (void)prepareUIWithBtn:(UIButton *)btn
{
    ...
    if (btn == _dataSource1Btn) {
        ...
        _filterTableView2 = [[GFFilterDataTableView alloc] initWithFrame:CGRectMake(0, self.bottom, self.width, 0)];
        ...
        _filterTableView3 = [[GFFilterDataTableView alloc] initWithFrame:CGRectMake(0, self.bottom, self.width, 0)];
...
- (void)prepareBgView
{
    ...
    _bgView.backgroundColor = [UIColor colorWithDisplayP3Red:0/255.0 green:0/255.0 blue:0/255.0 alpha:0.1];
